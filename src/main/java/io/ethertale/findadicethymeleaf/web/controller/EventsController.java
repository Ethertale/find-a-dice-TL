...
public class EventsController {
    ...
    public String toggleInterested(@PathVariable("id") UUID eventId, @AuthenticationPrincipal AuthenticationDetails authenticationDetails) {
        User loggedUser = userService.getUserById(authenticationDetails.getId());
        eventService.toggleInterested(eventId, loggedUser.getHero());
        return "redirect:/events/" + eventId;
    }

    @PostMapping("/{id}/going")
    public String toggleGoing(@PathVariable("id") UUID eventId, @AuthenticationPrincipal AuthenticationDetails authenticationDetails) {
        User loggedUser = userService.getUserById(authenticationDetails.getId());
